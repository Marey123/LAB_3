...
{
	std::vector<FigureProperties*> figures = getFigures();
...
std::vector<FigureProperties*> Controller::getFigures()
{
	std::vector<FigureProperties*> figures;
...
void Controller::generateCircle()
{
	generateFigure("Circle");
}

void Controller::generateRectangle()
{
...
{
	std::vector<FigureProperties*> figures = aggregate->getFigures();
